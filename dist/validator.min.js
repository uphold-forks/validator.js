...
!function(){/**
  * Validator
  */
function a(b){return this instanceof a?(this.__class__="Validator",this.__version__="2.0.3",this.options=b||{},void(this.bindingKey=this.options.bindingKey||"_validatorjsConstraint")):new a(b)}/**
  * Constraint
  */
